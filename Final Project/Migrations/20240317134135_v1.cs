        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Representative_BranchId = table.Column<int>(type: "int", nullable: true),
                    DiscountTypeId = table.Column<int>(type: "int", nullable: true),
                    Representative_Role = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Trader_BranchId = table.Column<int>(type: "int", nullable: true),
                    Trader_Role = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Branches_Representative_BranchId",
                        column: x => x.Representative_BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Branches_Trader_BranchId",
                        column: x => x.Trader_BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_DiscountTypes_DiscountTypeId",
                        column: x => x.DiscountTypeId,
                        principalTable: "DiscountTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_governorates_GoverId",
                        column: x => x.GoverId,
                        principalTable: "governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TraderSpecialPriceForCities_AspNetUsers_TraderId",
                        column: x => x.TraderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DiscountTypeId",
                table: "AspNetUsers",
                column: "DiscountTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_GoverId",
                table: "AspNetUsers",
                column: "GoverId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Representative_BranchId",
                table: "AspNetUsers",
                column: "Representative_BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Trader_BranchId",
                table: "AspNetUsers",
                column: "Trader_BranchId");
